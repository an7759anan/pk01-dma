...
// #define CLOCK_HZ        1500000000   // Pi 2 - 4
#define CLOCK_HZ        500000000   // Pi 2 - 4
// #define CLOCK_HZ        600000   // Pi 2 - 4
...
#define  REG64(m, x) ((volatile uint32_t *)((uint64_t)(m.virt)+(uint64_t)(x)))
...
#define MEM_BUS_ADDR(mp, a) ((uint64_t)a-(uint64_t)mp->virt+(uint64_t)mp->bus)
